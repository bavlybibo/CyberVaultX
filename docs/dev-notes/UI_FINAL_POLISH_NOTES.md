...
- Added scrollable page containers for Dashboard, Vault, Security Center, Local Security Coach, Proof Center, Generator, Trash, Activity, Settings, and About.
...
3. Confirm Settings, Local Security Coach, Proof Center, and Vault scroll vertically.
