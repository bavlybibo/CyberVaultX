...
The UI now feels like a real password-security assessment product instead of a small academic demo. The larger dataset also gives the Dashboard, Security Center, Local Security Coach, Trash, and reporting workflows enough data to look convincing during the live walkthrough.
