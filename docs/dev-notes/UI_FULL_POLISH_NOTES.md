...
- Added alternating table rows and risk-aware row coloring for Vault, Security Center, Local Security Coach, Trash, Activity, and History.
...
- Security and Local Security Coach rows visually communicate urgency.
