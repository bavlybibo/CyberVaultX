...
- AI Guardian `coach_overview` section with readiness summary, first user action, site profile mix, and UX prompts.
- AI Summary export now includes the AI Coach UX Snapshot.

## Improved
- AI Guardian mode upgraded to: `Local-first Explainable AI Guardian v5 · Site Policy Reasoner + Live Coach UX`.
