...
- AI Guardian context, plan generation, and previous snapshot persistence moved to `app/services/ai_guardian.py`.
...
- AI Guardian stores previous metrics in app metadata so “What Changed” can compare against the previous run.
